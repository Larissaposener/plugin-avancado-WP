...
class GithubWidget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => 'Widget do plugin Github da Larissa',
		);
		parent::__construct( 'GithubWidget', 'Github Widget', $widget_ops );
	}
	 
	public function widget( $args, $instance ) {
		//fazendo requisiçao pelo link do repositorio
		//Criando Funçao de request
 ...
 <?php 
	...
	public function form( $instance ) {
		...
		<label>quantidade de repositório: </label>
